package com.frafael.sensors.temperature.monitoring.api.controller;

import com.frafael.sensors.temperature.monitoring.api.model.SensorMonitoringOutput;
...
import com.frafael.sensors.temperature.monitoring.domain.repository.SensorMonitoringRepository;
...
public class SensorMonitoringController {
    ...
    public SensorMonitoringOutput getDetail(@PathVariable TSID sensorId) {
        SensorMonitoring sensorMonitoring = finadByIdOrDefault(sensorId);
    ...
    private SensorMonitoring finadByIdOrDefault(TSID sensorId) {
